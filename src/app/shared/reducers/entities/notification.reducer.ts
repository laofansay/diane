import {
   INotification,
   defaultValue,
} from '@/app/shared/model/notification.model'
import {
   EntityState,
   IQueryParams,
   createEntitySlice,
...
export const createEntity = createAsyncThunk(
   ...
   async (entity: INotification, thunkAPI) => {
      const result = await axios.post<INotification>(
         apiUrl,
         cleanEntity(entity)
      )
...
export const updateEntity = createAsyncThunk(
   ...
   async (entity: INotification, thunkAPI) => {
      const result = await axios.put<INotification>(
         `${apiUrl}/${entity.id}`,
         cleanEntity(entity)
      )
      thunkAPI.dispatch(getEntities({}))
...
export const partialUpdateEntity = createAsyncThunk(
   ...
   async (entity: INotification, thunkAPI) => {
      const result = await axios.patch<INotification>(
         `${apiUrl}/${entity.id}`,
         cleanEntity(entity)
      )
      thunkAPI.dispatch(getEntities({}))
