...
export const createEntity = createAsyncThunk(
   'order/create_entity',
   async (entity: OrderForm, thunkAPI) => {
      const result = await axios.post<OrderForm>(apiUrl, cleanEntity(entity))
...
export const updateEntity = createAsyncThunk(
   ...
   async (entity: IOrder, thunkAPI) => {
      const result = await axios.put<IOrder>(
         `${apiUrl}/${entity.id}`,
         cleanEntity(entity)
      )
      thunkAPI.dispatch(getEntities({}))
...
export const partialUpdateEntity = createAsyncThunk(
   ...
   async (entity: IOrder, thunkAPI) => {
      const result = await axios.patch<IOrder>(
         `${apiUrl}/${entity.id}`,
         cleanEntity(entity)
      )
      thunkAPI.dispatch(getEntities({}))
