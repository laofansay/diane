...
import { ASC } from '@/app/api/shared/util/pagination.constants';
import { cleanEntity } from '@/app/api/shared/util/entity-utils';
import { IQueryParams, createEntitySlice, EntityState, serializeAxiosError } from '@/app/api/shared/reducers/reducer.utils';
import { IProduct, defaultValue } from '@/app/api/shared/model/product.model';
