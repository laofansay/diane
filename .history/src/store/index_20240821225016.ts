...
import password from '@/app/shared/reducers/entities/account/password/password.reducer';
import settings from '@/app/shared/reducers/entities/account/settings/settings.reducer';
import register from '@/app/shared/reducers/entities/account/register/register.reducer';
