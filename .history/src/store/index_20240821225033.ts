...
import password from '@/app/shared/reducers/entities/account/password.reducer';
import settings from '@/app/shared/reducers/entities/account/settings.reducer';
import register from '@/app/shared/reducers/entities/account/register.reducer';
