...
export default function CartButton({ product }) {
   ...
   const cartItem = useAppSelector(state => state.cartItem.entity);
   ...
   return (
      <CartContextProvider>
         <ButtonComponent product={product, cartItem} />
      </CartContextProvider>
   )
}

export function ButtonComponent({ product, ICartItem: cartItem }) {
